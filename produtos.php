...
<body class="container-fluid vh-100 m-0 p-0 d-flex flex-column">
  ...
  <header class="d-flex bg-primary justify-content-around align-items-center">
    <?php
      echo '<i style="cursor: pointer;" onclick="history.back()" class="fa-solid fa-backward fa-2xl"></i>'
    ?>
  ...
  <main class="d-flex flex-column align-items-center py-3">
    ...
    <div class="row w-100 d-flex justify-content-around align-items-center">
      ...
      if (mysqli_num_rows($resultado) > 0) {
        ...
        echo '<a href="produtos.php?cat='.$linha['ProdutoID'].'" class="col-3 text-dark h-100 d-flex justify-content-center align-items-center flex-column p-3 bg-primary product-card" style="border: 0.15rem solid black; border-radius: 1rem;"> 
